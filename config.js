...
const CONFIG = {
  ...
  REVIEWED_OK: [
    ...
    { technician: "Mike Wells", item: "Dewalt Jack hammer", date: "2026-08-18",
      note: "Extra jackhammer return - Mike has 4 jackhammer check-outs and 5 returns, and every check-out is already paired. He has nothing outstanding, so this is a spare/duplicate entry. Reviewed by Ethan" },
    { technician: "Gavin Buchanan-Butler", item: "Water transfer pump w pink electric extension cord", date: "2026-08-18",
      note: "Same event as the 'Transfer pump' check-out 8/17 that was returned 8/18 - logged a second time with a longer description. Reviewed by Ethan" },
    { technician: "Gavin Buchanan-Butler", item: "Ext. cord", date: "2026-08-18",
      note: "Same cord as 'Extinction cord' (typo for extension), checked out and returned 8/18 - logged a second time. Reviewed by Ethan" },
    { technician: "Mike Wells", item: "Supports for plastic sheeting demolition", date: "2026-08-02",
      note: "Fuzzy auto-match verified: the return reads 'Supports for plastic sheeting FOR demolition' - same item, one extra word" },
